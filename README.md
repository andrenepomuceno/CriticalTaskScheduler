...
- **Optional FreeRTOS critical thread** on ESP32, RP2040, nRF52, STM32, and Teensy 4.x, behind `CRITICALTASKSCHEDULER_HAS_FREERTOS`. Any other platform with FreeRTOS can opt in with `-D CRITICALTASKSCHEDULER_HAS_FREERTOS=1`.
